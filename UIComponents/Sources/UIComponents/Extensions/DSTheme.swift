...
public struct DSTheme: Equatable {
    ...
    public init(
        brandColor: Color = DSColor.enamel,
        errorColor: Color = DSColor.alert,
        successColor: Color = DSColor.confirmed,
        warningColor: Color = DSColor.amber,
        surfaceColor: Color = DSColor.dsSurface,
        backgroundColor: Color = DSColor.paper,
        titleColor: Color = DSColor.ink,
        secondaryColor: Color = DSColor.ink60,
        borderColor: Color = DSColor.line,
